...
class Segmenter(LongestStringMatching):
    ...
    def __init__(
        ...
        *,
        ...
        :param max_word_length: Maximal word length this model allows.
    ...
    def _predict_sent(self, sent_str):
        segmented = super(Segmenter, self)._predict_sent(sent_str)
        return segmented
...
def segment(sent_str, cls=None):
    ...
    :param cls: A custom `Segmenter` class object for setting the maximal
        ...
        If not provided, a default segmenter is used, with maximal word
        length = 5.
