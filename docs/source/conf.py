...
# of the sidebar.
html_logo = "pycantonese-logo-white.svg"

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = "pycantonese-logo.ico"
...
htmlhelp_basename = 'PyCantonesedoc'
...
latex_documents = [
  ('index', 'PyCantonese.tex', u'PyCantonese Documentation',
   u'Jackson L. Lee', 'manual'),
]
...
man_pages = [
    ('index', 'pycantonese', 'PyCantonese Documentation',
     [author], 1)
]
...
texinfo_documents = [
  ('index', 'PyCantonese', u'PyCantonese Documentation',
   u'Jackson L. Lee', 'PyCantonese', 'One line description of project.',
   'Miscellaneous'),
]
